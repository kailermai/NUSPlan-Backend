...
def load_system_prompt():
    return """
        ...
        - If I have no upcoming tasks and events for the day, return "No events and tasks scheduled for the day"
        ...
        - If I do not provide a duration of a task, assume that the minimum time needed for it is 30 minutes and maximum time needed is 2 hoursg
